...
try:
    ...
    os.system('python2 cyberhackfb1.py')
...
\033[1;96m................\033[1;93mlmk\033[1;91m...............
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/lmk)

	    os.system('cd $HOME && git clone https://github.com/lmk45/cyberhackfb1.git
...
Is)
	    ...
	    os.system('cd $HOME/lmk4& && python2 cyberhackfb1.py')
...
def pb():
	...
	os.system('python2 cyberhackfb 1.py')
